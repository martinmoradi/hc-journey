...
export const GuideViewer: React.FC = () => {
  const { allSteps, totalSteps, isLoading, error, currentStepIndex, markStepAsCompleted } =
    useGuide();
    ...
    return (
      <div className="flex items-center justify-center h-full p-8 bg-linear-to-b from-[#0f1419] via-[#1a1f2e] to-[#0f1419]">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">Failed to Load Guide</h2>
          ...
          <div className="px-6 py-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
            <p className="text-sm text-gray-400">
              Try refreshing the page or selecting a different race/class combination.
            </p>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="flex items-center justify-center h-full p-8 bg-linear-to-b from-[#0f1419] via-[#1a1f2e] to-[#0f1419]">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">No Guide Loaded</h2>
